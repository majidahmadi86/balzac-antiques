        ...
        {sp?.sent === "1" ? (
          ...
          <div className="mx-auto mt-12 max-w-xl border-t border-hairline pt-10">
            ...
            <form action={submitContact} className="mt-6 grid gap-4">
              ...
              <label className="block">
                <span className="mb-1.5 block text-[10px] uppercase tracking-[0.22em] text-ink/60"><T k="contact.msg" /></span>
                <textarea name="body" required rows={6} maxLength={5000} className="w-full border border-hairline bg-cream px-4 py-2.5 text-[15px] text-ink outline-none transition-colors focus:border-gold resize-y" />
              </label>
